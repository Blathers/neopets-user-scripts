...
// @match        https://neopets.com/haggle.phtml
// @match        https://www.neopets.com/market.phtml?type=sales
// @match        https://neopets.com/market.phtml?type=sales
...
(async () => {
 ...
 background-color: #E5E5E5;
    ...
    const actBasedOnLocation = async ()=>{
        var onMarketPlace = (document.URL == "https://www.neopets.com/market.phtml?type=sales" || document.URL == "https://neopets.com/market.phtml?type=sales");
        if (onMarketPlace){
            await displaySavedItems();
        }
        else
